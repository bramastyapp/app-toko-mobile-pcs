...
class BayarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val txtTotalTrasaksiBayar = view.findViewById<TextView>(R.id.txtTotalTransaksiBayar)
        txtTotalTrasaksiBayar.setText(numberFormat.format(total.toString().toDouble()).toString())
        ...
        btnSimpanBayar.setOnClickListener{
            val penerimaan = txtPenerimaan.text.toString().toInt()
            val totalbayar = total.toString().toInt()

            if(penerimaan<totalbayar){
                AlertDialog.Builder(view.context)
                    .setTitle("Uang anda kurang!")
                    .setMessage("Bayarlah sesuai total yang harus di bayar")
                    .show()
            }else{
                api.postTransaksi(token.toString(),adminId.toString().toInt(),total.toString().toInt()).enqueue(object :
                    ...
                    override fun onResponse(
                        ...
                        Log.d("id_transaksi", id_transaksi.toString())
